...
public class FrozenGame extends GameScreen {
                    ...
                    LevelManager levelManager_arg)
  {
    ...
    if (FrozenBubble.getMode() == FrozenBubble.GAME_NORMAL) {
      nextBubble = new ImageSprite(new Rect(352, 390, 352 + 32, 390 + 32),  //302, 440, 302 + 32, 440 + 32
                                   bubbles[nextColor]);
    } else {
      nextBubble = new ImageSprite(new Rect(352, 390, 352 + 32, 390 + 32),
  ...
  private void initFrozenify()
  {
    ...
    ImageSprite freezeNextBubble =
        new ImageSprite(new Rect(351, 389, 34, 42), frozenBubbles[nextColor]);
